樹問題小結：基礎1
====
樹的基礎知識我懶得寫了，請直接參考[馬叔叔](http://users.cis.fiu.edu/~weiss/)的書。這裡主要蔥結關於樹的一些或基本或重要或有趣的問題（不包括高級樹形結構如 [AVL Tree](https://github.com/g7tianyi/my-acm-solutions/blob/master/algo/avl-tree.md), [Splay Tree](https://github.com/g7tianyi/my-acm-solutions/blob/master/algo/splay-tree.md)等），主要包括：
 ...
 - **樹的深拷貝(遞歸/非遞歸)**
 - **樹的比較**
      樹的比較其實是比較大的問題，我粗略一想，全面的討論可能至少包括：
     * 判斷兩棵樹是否完全一樣
     * 判斷兩棵樹是否同構（難）
     * 判斷兩棵樹互為鏡像
 - **元素的查找**
